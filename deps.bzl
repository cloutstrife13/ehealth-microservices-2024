...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:aBGI9TeQ4MPlhquTQKq9XbK79rKFVwXNUAYz9aXyEBE=",
    ...
    go_repository(
        ...
        sum = "h1:zlnbNHxumkRvfPWgfXu8RBwyNR1x8wh9cf5PTOCqs9Q=",
        version = "v1.3.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:T9THsdP1woyAqKHwjkEsbCnMefsAFvk8iJJKokcJ3Go=",
        version = "v2.15.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Bu7I/G4ilJlbfzjmU39O9N+2uO1pBcMK045fzZ4ytNg=",
        version = "v0.1.12",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:FHPgTTj5UqjlBye4PA4/oxknCY+kQ9K34XAi8d37glA=",
        version = "v0.1.12",
    )
    go_repository(
        ...
        sum = "h1:ZnSJQ+ri9x46Yz15wHqSb93Q03yY12XMVLUFDJJ0+/g=",
        version = "v0.0.24-0.20240408172741-99c879ba0ede",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rOkHflVuulFKlwsLY01/M2cM2tWCjDoETcMqKbAWu1M=",
        version = "v3.8.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:syWey5xaNHZgicYBemv0nohUPPmaLteiBEUT6Q5+F/4=",
        version = "v1.34.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XueI6sQtgS7du45fyBCNkNfPQ9SINaYavMFNOxp37SA=",
        version = "v2.20.34",
    )
    go_repository(
        ...
        sum = "h1:hysDXtdGZIRF5UZXwpfn3ZWRbm+ru4l53/ajBRGpCTw=",
        version = "v2.7.15",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:W0VwIhcEVhRflwL9as3dhY6jXjVCA27AkmbnZ+UTh3U=",
        version = "v0.31.0",
    )
    go_repository(
